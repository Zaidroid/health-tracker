        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                onClick={signOut}
                className="inline-flex items-center px-3 py-2 border border-transparent text-sm font-medium rounded-md text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200"
              >
              ...
              <div className="md:hidden relative">
                ...
                <nav
                  ...
                  } md:hidden fixed inset-y-0 right-0 w-64 bg-white dark:bg-gray-800 overflow-y-auto z-50 transition-transform transform ${
                    mobileMenuOpen ? 'translate-x-0' : 'translate-x-full'  // Changed to translate-x-full
